		...
		<section class="error-404 not-found">
			...
			<div class="page-content">
				<p><?php esc_html_e( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'physiologix' ); ?></p>
					...
					$physiologix_archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'physiologix' ), convert_smilies( ':)' ) ) . '</p>';
					the_widget( 'WP_Widget_Archives', 'dropdown=1', "after_title=</h2>$physiologix_archive_content" );
